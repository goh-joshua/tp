...
/**
 * Unit tests for {@link JsonAdaptedOrganization}.
 */
public class JsonAdaptedOrganizationTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedOrganization organization =
                new JsonAdaptedOrganization(INVALID_NAME, VALID_PHONE, VALID_EMAIL);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedOrganization organization =
                new JsonAdaptedOrganization(null, VALID_PHONE, VALID_EMAIL);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedOrganization organization =
                new JsonAdaptedOrganization(VALID_NAME, INVALID_PHONE, VALID_EMAIL);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedOrganization organization =
                new JsonAdaptedOrganization(VALID_NAME, null, VALID_EMAIL);
        String expectedMessage = String.format(MISSING_FIELD_MESSAGE_FORMAT,
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedOrganization organization =
                new JsonAdaptedOrganization(VALID_NAME, VALID_PHONE, INVALID_EMAIL);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedOrganization organization =
                new JsonAdaptedOrganization(VALID_NAME, VALID_PHONE, null);
        String expectedMessage = String.format(MISSING_FIELD_MESSAGE_FORMAT,
