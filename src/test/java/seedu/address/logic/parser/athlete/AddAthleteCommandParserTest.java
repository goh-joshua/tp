...
import static seedu.address.logic.commands.athlete.AthleteCommandTestUtil.*;
...
public class AddAthleteCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + SPORT_DESC_BOB
                + AGE_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB, new AddAthleteCommand(expectedAthlete));
    }
